...
public class FollowingMomentFragment extends Fragment implements
        MomentAdapter.OnMomentInteractionListener, MomentDetailFragment.OnMomentDetailFragmentInteractionListener{

    public static final String TAG = "FollowingMomentFragment";
    ...
    private OnFollowingMomentFragmentInteractionListener mListener;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case TO_REFRESH:
                    ...
                    break;
                case TO_LOADMORE:
                    ApiController.getFollowingMoments(mMomentList.getPage() + 1, new Response.Listener<MomentList>() {
                        @Override
                        public void onResponse(MomentList response) {
                            mMomentList = response;
    ...
    public static FollowingMomentFragment newInstance(MomentList momentList) {
        FollowingMomentFragment fragment = new FollowingMomentFragment();
    ...
    public void onAttach(Activity activity) {
        ...
        mActivity = activity;
        try {
            mListener = (OnFollowingMomentFragmentInteractionListener) activity;
    ...
    public interface OnFollowingMomentFragmentInteractionListener {
        void OnFollowingMomentFragmentInteraction(Uri uri);
    }
